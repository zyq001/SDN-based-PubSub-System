...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- h3 -->
    <xsl:template
            match="*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/title ')]"
            priority="4">
    ...
    <!-- h4 -->
    <xsl:template
            match="*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/title ')]"
            priority="5">
        <fo:block xsl:use-attribute-sets="topictitle4">
            <xsl:if test="$trace='yes'">
                <fo:inline color="purple"></fo:inline>
            </xsl:if>
            <xsl:call-template name="get-title"/>
        </fo:block>
    </xsl:template>
    ...
    <!-- h5 -->
    <xsl:template
            match="*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/title ')]"
            priority="6">
    ...
    <!-- h6 -->
    <xsl:template
            match="*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/title ')]"
            priority="7">
    ...
    <xsl:template match="*[contains(@class,' topic/table ')]/*[contains(@class,' topic/title ')]">
        ...
        <fo:block font-weight="bold">
            <fo:inline color="red"><xsl:value-of select="$tbl-pfx-txt"/>.
            </fo:inline>
            <xsl:apply-templates/>
        </fo:block>
    </xsl:template>
    ...
    <xsl:template match="*[contains(@class,' topic/fig ')]/*[contains(@class,' topic/title ')]">
        ...
        <fo:block font-weight="bold">
            <fo:inline color="red"><xsl:value-of select="$fig-pfx-txt"/>.
            </fo:inline>
            <xsl:apply-templates/>
        </fo:block>
    </xsl:template>
    ...
    <xsl:template name="place-tbl-lbl">
        ...
        <xsl:choose>
            ...
            <xsl:when test="*[contains(@class,' topic/desc ')]">
                <fo:block>****<xsl:value-of select="*[contains(@class,' topic/desc ')]"/>
                </fo:block>
            </xsl:when>
        </xsl:choose>
    </xsl:template>
    ...
    <xsl:template name="get-title"><!-- get fully-processed title content by whatever mechanism -->
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:apply-templates/>
                <!-- select="title|*[contains(@class,' topic/title ')]"/-->
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
