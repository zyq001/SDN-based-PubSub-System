...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template
            match="*[contains(@class,' topic/ul ')]|*[contains(@class,' topic/ol ')]|*[contains(@class,' topic/sl ')]">
    ...
    <xsl:template match="*[contains(@class,' topic/ul ')]/*[contains(@class,' topic/li ')]">
        ...
        <xsl:variable name="extra-list-indent"><xsl:value-of select="number($list-level)*16"/>pt
        </xsl:variable>
        <fo:list-item>
    ...
    <xsl:template match="*[contains(@class,' topic/dd ')]">
        ...
        <fo:block>
            <xsl:attribute name="start-indent">
                ...
                <xsl:value-of select="$extra-list-indent"/>
            </xsl:attribute>
            <!--
