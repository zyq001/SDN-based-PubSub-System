 ...
 * 2012-11-13T15:21:18.450+08:00
 * Generated source version: 2.3.2
 */


@WebServiceClient(name = "PublisherRegistrationManagerService",
...
public class PublisherRegistrationManagerService extends Service {
	...
	public final static QName SERVICE = new QName("http://servicemix.apache.org/wsn/jaxws", "PublisherRegistrationManagerService");
	...
	public PublisherRegistrationManagerService(URL wsdlLocation) {
	...
	/**
	 * @return returns PublisherRegistrationManager
	 */
	@WebEndpoint(name = "JBI")
	public PublisherRegistrationManager getJBI() {
		return super.getPort(JBI, PublisherRegistrationManager.class);
	}
	 ...
	 */
	@WebEndpoint(name = "JBI")
	public PublisherRegistrationManager getJBI(WebServiceFeature... features) {
		return super.getPort(JBI, PublisherRegistrationManager.class, features);
	}
