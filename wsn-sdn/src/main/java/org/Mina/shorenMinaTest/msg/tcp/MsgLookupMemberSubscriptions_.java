...
public class MsgLookupMemberSubscriptions_ extends WsnMsg implements Serializable {

	public TreeSet<String> topics;

	public void initMsgLookupMemberSubscriptions_() {
		this.topics = new TreeSet<String>();
	}
