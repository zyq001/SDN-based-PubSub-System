...
//
//import jaxe.DialogueDepart;
//import jaxe.Jaxe;
//import jaxe.JaxeFrame;
//import jaxe.JaxeResourceBundle;
//
//
//public class PSManagerUI3 implements IAdminUI{
//
//	//private  Text text;
...
//				public JPanel allGroupsPane;//所有集群			
...
//	private List<TargetGroup> currentTargetGroups = new ArrayList<TargetGroup>();// 受限集群框内 被选中的集群名称和
...
//	
//	//存放集群按钮的集合
//	public Map<String,ConcurrentHashMap<String,ArrayList<String>>> globalSubInfo;//<groupname<subers,subs>>
//	protected PopupMenu popupMenu = null;//系统托盘菜单
////	protected MenuItem mainFrameItem;
//	
...
//	 */
//	public PSManagerUI3(AdminMgr interactIF1) {
//		interactIF = interactIF1;
//		topicTreeManager = new TopicTreeManager(data,this);
//		policyList = ShorenUtils.getAllPolicy();
//		JFrame.setDefaultLookAndFeelDecorated(true);
//		globalSubInfo = new ConcurrentHashMap<String,ConcurrentHashMap<String,ArrayList<String>>>();
//		/**					
//		*com.jtattoo.plaf.aluminium.AluminiumLookAndFeel 椭圆按钮+翠绿色按钮背景+金属质感
//		*
//		*/
...
//		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(PSManagerUI.class.getResource("/com/bupt/wangfu/Swing/res/INT25.png")));
...
//		            Image image = null;
//		             try {
//		                 image = ImageIO.read(PSManagerUI.class.getResource("/com/bupt/wangfu/Swing/res/INT20.png")); // 载入图片,这里要写你的图标路径哦
//		             } catch (IOException e1) {}
//		            // 创建弹出菜单
//		            popupMenu = new PopupMenu();
//		            MenuItem mainFrameItem = new MenuItem("Show");
...
//		            TrayIcon trayIcon = new TrayIcon(image, "发布订阅管理器", popupMenu);// 创建trayIcon
...
//		         else
//		         {
//		             JOptionPane.showMessageDialog(frame,"本系统不支持最小化至系统托盘！","通知",JOptionPane.OK_OPTION);
//		         }
//				}else{
//					frame.setVisible(false);
//				}
...
//		visualManagement.addTab("", new ImageIcon(PSManagerUI.class.getResource("/com/bupt/wangfu/Swing/res/GroupM.png")), groupsMgmt, null);
...
//		
//		lblNewLabel_4 = new JLabel("\u5F53\u524D\u6240\u6709\u96C6\u7FA4\u4FE1\u606F\uFF08\u70B9\u51FB\u67E5\u8BE2\uFF09");
...
//		
//		
//		scrollPane_2 = new JScrollPane(suber);
//		scrollPane_2.setSize(new Dimension(430, 240));
//		scrollPane_2.setViewportView(suber);
//		scrollPane_2.setOpaque(false);
//		scrollPane_2.setBounds(0, 93, 199, 147);
//		subscbs.add(scrollPane_2);
//		
//	
//		JLabel lblNewLabel = new JLabel("集群成员订阅查询\r\n(按ip)");
//		lblNewLabel.setBounds(27, 10, 150, 15);
//		subscbs.add(lblNewLabel);
//		
//		groupsNameOrIPInput = new JTextField();
//		groupsNameOrIPInput.setBounds(10, 35, 189, 21);
...
//			}
//		);
//		checkButton.setBounds(106, 66, 93, 23);
...
//		subsScrollPane.setLocation(209, 0);
//		subsScrollPane.setSize(new Dimension(410, 240));
...
//				svGroup.childrenSize=Integer.parseInt(childrenSizeInputC.getText());
...
//				svGroup.lostThreshold=Long.parseLong(lostThresholdInputC.getText());
...
//				conf.neighborSize=Integer.parseInt(childrenSizeInputC.getText());
...
//				conf.lostThreshold=Long.parseLong(lostThresholdInputC.getText());
...
//		//初始化的时候即显示默认值
//				GroupConfiguration initInfo = configFile.ReadGroupConfiguration("Default");
...
//				svGroup.childrenSize=Integer.parseInt(childrenSizeInput.getText());
...
//				svGroup.lostThreshold=Long.parseLong(lostThresholdInput.getText());
...
//		visualManagement.addTab("", new ImageIcon(PSManagerUI.class.getResource("/com/bupt/wangfu/Swing/res/TopicTree.png")), topicTreeM, null);
//		
//		try {
...
//		
//		policyM = new JPanel();
//		visualManagement.addTab("", new ImageIcon(PSManagerUI.class.getResource("/com/bupt/wangfu/Swing/res/policy.png")), policyM, null);
...
//			//DefaultMutableTreeNode tempTree = (DefaultMutableTreeNode)trees.nextElement();
...
//				System.out.print("comboBox.getSelectedItem().toString()"+comboBox.getSelectedItem().toString());
...
//				}else if(currentChosenTopicEntry!=null&&currentChosenTopicEntry.getTopicPath()!=null){
//					
...
//		lblNewLabel_2.setIcon(new ImageIcon(PSManagerUI.class.getResource("/com/bupt/wangfu/Swing/res/INT100.png")));
//		lblNewLabel_2.setBounds(162, 250, 106, 105);
//		sys.add(lblNewLabel_2);
//		
//		lblNewLabel_3 = new JLabel("");
//		lblNewLabel_3.setIcon(new ImageIcon(PSManagerUI.class.getResource("/com/bupt/wangfu/Swing/res/bupt.png")));
...
//            		lblNewLabel_5.setText("        当前：" + jChooser.getSelectedFile().getName());
//            		lblNewLabel_5.setName(jChooser.getSelectedFile().getName());
//            		}
//            	}
//            });
...
//            		
//            	//	String chosenTopicPath ="ou="+selectedTopic+",ou=all_test,dc=wsn,dc=com";
//            	//	TopicEntry newSchema = ShorenUtils.ldap.getByDN(chosenTopicPath);
//            	}
//            });
...
//    					e1.printStackTrace();
//    				}
//            		Jaxe.schemaFrame.ouvrir(new File("schema/"+lblNewLabel_5.getName()+".xsd"));
//            		
//            	}
//            });
//            
...
//            visualManagement.addTab("", new ImageIcon(PSManagerUI.class.getResource("/com/bupt/wangfu/Swing/res/shcemaM.png")), schemaPanel, null);
//		
//	}
//	
//	//根据当前所选的主题，显示受限集群
...
//		}
//				
//		if(currentChosenTopicEntry != null&&currentChosenTopicEntry.getWsnpolicymsg()!=null){
...
////			tPolicy[i][1] = policyList.get(i).getTargetGroups().toString();
//			
//			tableModel.addRow(new Object[]{policyList.get(i).getTargetTopic(),policyList.get(i).getTargetGroups().toString()});
//			
//		}
//		
//		table.invalidate();
...
//		/*
//		aGroupItem.GroupAddress=address;
//		aGroupItem.GroupName=name;
...
//					defaultConfig=configFile.ReadGroupConfiguration("Default");
...
////		while(trees.hasMoreElements()){
////			//DefaultMutableTreeNode tempTree = (DefaultMutableTreeNode)trees.nextElement();
////			DefaultMutableTreeNode temp = (DefaultMutableTreeNode)trees.nextElement();
////			
...
////					public void run() {
//						// TODO Auto-generated method stub
//						text.append(new Date()+"集群"+recoverGroup.name+"代表地址为"+recoverGroup.addr+"端口号"+recoverGroup.tPort+"恢复成功"+"\r\n");
//						text.paintImmediately(text.getBounds());
