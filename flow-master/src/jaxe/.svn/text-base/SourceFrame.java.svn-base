...
public class SourceFrame extends JFrame implements ActionListener {
    ...
    public void miseAJour() {
        ...
        try {
            final BufferedReader in = new BufferedReader(jdoc.getReader(prefIndenter));
        ...
        StyleConstants.setForeground(styleElement, new Color(150, 0, 0)); // rouge fonc�        styleNomAttribut = textPane.addStyle(null, defaultStyle);
        StyleConstants.setForeground(styleNomAttribut, new Color(0, 0, 150)); // bleu fonc�        styleValeurAttribut = textPane.addStyle(null, defaultStyle);
        StyleConstants.setForeground(styleValeurAttribut, new Color(0, 100, 0)); // vert fonc�        styleEntite = textPane.addStyle(null, defaultStyle);
        StyleConstants.setForeground(styleEntite, new Color(0, 100, 100)); // cyan fonc�        styleCommentaire = textPane.addStyle(null, defaultStyle);
    ...
    /**
     * Buffer de caract鑢es du document
     */
    class Buffer {
        int tailleMax = 200;
        String sbuff;
        int debut, fin; // fin n'inclut pas le dernier caract鑢e du buffer
    ...
    public void colorier(final int debut, final int fin) {
        ...
        // si on est toujours dans un commentaire �la fin de la zone, on continue �colorier au-del�        if (dansCommentaire) {
  ...
  //  }
    ...
    /**
     * Positionne le document �la ligne indiqu閑 (la premi鑢e ligne a le num閞o 1)
     */
    public void allerLigne(int ligne) {
        ...
        // bidouille pour afficher la position en haut de la fen阾re
        try {
    ...
    /**
     * S閘ectionne la ligne indiqu閑 (la premi鑢e ligne a le num閞o 1)
     */
    ...
    /**
     * Sp閏ifie la taille des tabulations, en 閝uivalent-caract鑢es (on utilise la taille du 'w' comme r閒閞ence)
     */
