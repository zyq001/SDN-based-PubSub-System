<xsl:stylesheet xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="*[contains(@class,' topic/topic ')]" mode="outline">
        ...
        <fo:bookmark>
                ...
                <xsl:choose>
                    <xsl:when test="*[contains(@class,' topic/titlealts ')]/*[contains(@class, ' topic/navtitle ')]">
                        <xsl:apply-templates
                                ...
                                mode="text-only"></xsl:apply-templates>
                    </xsl:when>
                    <xsl:otherwise>
            ...
            <xsl:apply-templates select="child::*[contains(@class,' topic/topic ')]"
                                 mode="outline"></xsl:apply-templates>
        </fo:bookmark>
    </xsl:template>
            ...
            <fo:page-sequence-master master-name="chapter-master">
                <fo:repeatable-page-master-alternatives>
                    <fo:conditional-page-master-reference page-position="first" odd-or-even="odd"
                                                          master-reference="common-page"></fo:conditional-page-master-reference>
            ...
            <fo:flow flow-name="xsl-region-body">
                <fo:block text-align="right" font-family="Helvetica">
                    ...
                    <fo:block font-size="30pt" font-weight="bold" line-height="140%">
                        <xsl:choose>
                            <xsl:when test="//*[contains(@class,' bkinfo/bkinfo ')]">
                                <xsl:value-of
                                        select="//*[contains(@class,' bkinfo/bkinfo ')]/*[contains(@class,' topic/title ')]"></xsl:value-of>

                                <xsl:apply-templates
                                        select="//*[contains(@class,' bkinfo/bkinfo ')]/@id"></xsl:apply-templates>
                            </xsl:when>
                            <xsl:when test="@title">
                    ...
                    <fo:block font-size="24pt" font-weight="bold" line-height="140%" margin-bottom="1in">
                        <xsl:value-of
                                select="//*[contains(@class,' bkinfo/bkinfo ')]/*[contains(@class,' bkinfo/bktitlealts ')]/*[contains(@class,' bkinfo/bksubtitle ')]"></xsl:value-of>
                    </fo:block>
                    ...
                    <fo:block margin-top="3pc" font-size="11pt" font-weight="bold" line-height="normal">©    Copyright
                        ...
                        <xsl:text></xsl:text>
                        <xsl:value-of
                                select="//*[contains(@class,' bkinfo/bkcopyrfirst ')]"></xsl:value-of>,<xsl:value-of
                                select="//*[contains(@class,' bkinfo/bkcopyrlast ')]"></xsl:value-of>.
                    </fo:block>
                </fo:block>
    ...
    <xsl:template name="place-cover-art">
        ...
        <fo:block margin-top="2pc" font-family="Helvetica" border-style="dashed" border-color="black"
                  border-width="thin" padding="6pt">
            ...
            <fo:flow flow-name="xsl-region-body">
                ...
                <fo:block line-height="12pt" font-size="10pt" font-family="Helvetica" id="page1-1">
                    <fo:block text-align="left" font-family="Helvetica">
                        <fo:block>
                            <fo:leader color="black" leader-pattern="rule" rule-thickness="3pt"
                                       leader-length="2in"></fo:leader>
                        </fo:block>
