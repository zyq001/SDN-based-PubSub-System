...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="img-path"></xsl:variable>
    <!-- this will be specific to your delivery tree! -->
    <xsl:param name="dflt-ext">.jpg</xsl:param>
    <!-- this sets whatever your preferred extension is for your graphics -->
    ...
    <xsl:attribute-set name="lq">
        ...
        <xsl:attribute name="start-indent">
            <xsl:value-of select="$basic-start-indent"/> + 20pt
        </xsl:attribute>
        <xsl:attribute name="end-indent">
            <xsl:value-of select="$basic-end-indent"/> + 20pt
        </xsl:attribute>
