...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <tr>
            ...
            <xsl:choose>      <!-- Process <proptype> -->
                ...
                <xsl:when test="following-sibling::*/*[contains(@class,' reference/proptype ')]">
                    <th valign="bottom">
                        <xsl:attribute name="id"><xsl:value-of select="generate-id(parent::*)"/>-type
                        </xsl:attribute>
            ...
            <xsl:choose>      <!-- Process <propvalue> -->
                ...
                <xsl:when test="following-sibling::*/*[contains(@class,' reference/propvalue ')]">
                    <th valign="bottom">
                        <xsl:attribute name="id"><xsl:value-of select="generate-id(parent::*)"/>-value
                        </xsl:attribute>
                        <xsl:call-template name="th-align"/>
                        <xsl:call-template name="getString">
            ...
            <xsl:choose>      <!-- Process <propdesc> -->
                ...
                <xsl:when test="following-sibling::*/*[contains(@class,' reference/propdesc ')]">
                    <th valign="bottom">
                        <xsl:attribute name="id"><xsl:value-of select="generate-id(parent::*)"/>-desc
                        </xsl:attribute>
                        <xsl:call-template name="th-align"/>
                        <xsl:call-template name="getString">
    ...
    <xsl:template name="addPropertiesHeadersAttribute">
        ...
        <xsl:attribute name="headers">
            <xsl:choose>
                ...
                <xsl:when
                        test="ancestor::*[contains(@class,' reference/properties ')]/*[1][contains(@class,' reference/prophead ')]/*[contains(@class,$classVal)]/@id">
                    <xsl:value-of
                            select="ancestor::*[contains(@class,' reference/properties ')]/*[1][contains(@class,' reference/prophead ')]/*[contains(@class,$classVal)]/@id"/>
                </xsl:when>
                <!-- Second choice: if there is a matching cell inside a user-specified header, use its generated ID -->
                <xsl:when
                        test="ancestor::*[contains(@class,' reference/properties ')]/*[1][contains(@class,' reference/prophead ')]/*[contains(@class,$classVal)]">
                    <xsl:value-of
                            select="generate-id(ancestor::*[contains(@class,' reference/properties ')]/*[1][contains(@class,' reference/prophead ')]/*[contains(@class,$classVal)])"/>
                </xsl:when>
                <!-- Third choice: no user-specified header for this column. ID is based on the table's generated ID. -->
                <xsl:otherwise>
                    <xsl:value-of select="generate-id(ancestor::*[contains(@class,' reference/properties ')])"/>-<xsl:value-of
                        select="$elementType"/>
                </xsl:otherwise>
            </xsl:choose>
        </xsl:attribute>
    ...
    <xsl:template match="*[contains(@class,' reference/property ')]" name="topic.reference.property">
        ...
        <tr>
            ...
            <xsl:choose>      <!-- Process or create proptype -->
                ...
                <xsl:when
                        test="../*/*[contains(@class,' reference/proptype ')] | ../*[1]/*[contains(@class,' reference/proptypehd ')]">
            ...
            <xsl:choose>      <!-- Process or create propvalue -->
                ...
                <xsl:when
                        test="../*/*[contains(@class,' reference/propvalue ')] | ../*[1]/*[contains(@class,' reference/propvaluehd ')]">
                    <td>    <!-- Create an empty cell. Add accessiblity attribute. -->
                        <xsl:call-template name="addPropertiesHeadersAttribute">
            ...
            <xsl:choose>      <!-- Process or create propdesc -->
                ...
                <xsl:when
                        test="../*/*[contains(@class,' reference/propdesc ')] | ../*[1]/*[contains(@class,' reference/propdeschd ')]">
                    <td>    <!-- Create an empty cell. Add accessiblity attribute. -->
                        <xsl:call-template name="addPropertiesHeadersAttribute">
    ...
    <xsl:template match="*" mode="propertiesEntry">
        ...
        <td valign="top">
            ...
            <xsl:call-template name="addPropertiesHeadersAttribute">
                <xsl:with-param name="classVal">reference/prop<xsl:value-of select="$elementType"/>hd<xsl:text> </xsl:text>
                </xsl:with-param>
