...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
            ...
            <xsl:when test="$biditest='bidi'">
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        ...
                        <xsl:call-template
                                name="start-rev-art"> <!-- BIDI, use English end graphic for start of change-->
    ...
    <xsl:template name="gen-style">
        ...
        <xsl:choose>
            <xsl:when
                    test="$conflictexist='true' and $FILTERDOC/val/style-conflict[@foreground-conflict-color or @background-conflict-color]">
    ...
    <xsl:template match="*" mode="ditamsg:cannot-flag-inline-element">
        ...
        <xsl:call-template name="output-message">
            ...
            <xsl:with-param name="msgparams">%i=<xsl:value-of select="$attr-name"/>
            </xsl:with-param>
        </xsl:call-template>
    </xsl:template>
