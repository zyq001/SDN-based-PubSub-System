...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                        ...
                        <xsl:attribute name="href">
                            <xsl:choose>
                                <xsl:when test="contains(@href,$DITAEXT)">
                                    <xsl:value-of select="substring-before(@href,$DITAEXT)"/><xsl:value-of
                                        select="$OUTEXT"/><xsl:value-of select="substring-after(@href,$DITAEXT)"/>
                                </xsl:when>
                                <xsl:otherwise>
    ...
    <xsl:template xmlns:exsl="http://exslt.org/common" name="getMatchingTarget">
        <xsl:param name="m_glossid" select="''"/>
        <xsl:param name="m_entry-file-contents"/>
        <xsl:param name="m_reflang" select="en_US"/>
        <xsl:choose>
            <xsl:when
                    test="$m_glossid='' and $m_entry-file-contents//*[contains(@class, ' glossentry/glossentry ')][lang($m_reflang)]">
                <xsl:copy-of
                        select="$m_entry-file-contents//*[contains(@class, ' glossentry/glossentry ')][lang($m_reflang)]"/>
            </xsl:when>
            <xsl:when
                    test="not($m_glossid='') and $m_entry-file-contents//*[contains(@class, ' glossentry/glossentry ')][@id=$m_glossid][lang($m_reflang)]">
                <xsl:copy-of
                        select="$m_entry-file-contents//*[contains(@class, ' glossentry/glossentry ')][@id=$m_glossid][lang($m_reflang)]"/>
            </xsl:when>
            <xsl:when
                    test="$m_glossid='' and $m_entry-file-contents//*[contains(@class, ' glossentry/glossentry ')][lang($DEFAULTLANG)]">
                <xsl:copy-of
                        select="$m_entry-file-contents//*[contains(@class, ' glossentry/glossentry ')][lang($DEFAULTLANG)]"/>
            </xsl:when>
            <xsl:when
                    test="not($m_glossid='') and $m_entry-file-contents//*[contains(@class, ' glossentry/glossentry ')][@id=$m_glossid][lang($DEFAULTLANG)]">
                <xsl:copy-of
                        select="$m_entry-file-contents//*[contains(@class, ' glossentry/glossentry ')][@id=$m_glossid][lang($DEFAULTLANG)]"/>
            </xsl:when>
            <xsl:when
                    test="$m_glossid='' and $m_entry-file-contents//*[contains(@class, ' glossentry/glossentry ')][not(@xml:lang) or normalize-space(@xml:lang)='']">
                <xsl:copy-of
                        select="$m_entry-file-contents//*[contains(@class, ' glossentry/glossentry ')][not(@xml:lang) or normalize-space(@xml:lang)=''][1]"/>
            </xsl:when>
            <xsl:when
                    test="not($m_glossid='') and $m_entry-file-contents//*[contains(@class, ' glossentry/glossentry ')][@id=$m_glossid][not(@xml:lang) or normalize-space(@xml:lang)='']">
                <xsl:copy-of
                        select="$m_entry-file-contents//*[contains(@class, ' glossentry/glossentry ')][@id=$m_glossid][not(@xml:lang) or normalize-space(@xml:lang)=''][1]"/>
            </xsl:when>
            <xsl:otherwise>
    ...
    <xsl:template xmlns:exsl="http://exslt.org/common" match="*" mode="getMatchingSurfaceForm">
        ...
        <xsl:choose>
            <xsl:when test="not($m_matched-target='#none#')">
                <xsl:choose>
                    <xsl:when
                            test="exsl:node-set($m_matched-target)/*[contains(@class, ' glossentry/glossentry ')][1]//*[contains(@class, ' glossentry/glossSurfaceForm ')][normalize-space(text())!='']">
                        <xsl:value-of
                                select="exsl:node-set($m_matched-target)/*[contains(@class, ' glossentry/glossentry ')][1]//*[contains(@class, ' glossentry/glossSurfaceForm ')][normalize-space(text())!='']"/>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:value-of
                                select="exsl:node-set($m_matched-target)/*[contains(@class, ' glossentry/glossentry ')][1]//*[contains(@class, ' glossentry/glossterm ')][normalize-space(text())!='']"/>
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:when>
            <xsl:otherwise>
    ...
    <xsl:template xmlns:exsl="http://exslt.org/common" match="*" mode="getMatchingAcronym">
        <xsl:param name="m_matched-target"/>
        <xsl:param name="m_keys"/>
        <xsl:choose>
            <xsl:when test="not($m_matched-target='#none#')">
                <xsl:choose>
                    <xsl:when
                            test="exsl:node-set($m_matched-target)/*[contains(@class, ' glossentry/glossentry ')][1]//*[contains(@class, ' glossentry/glossStatus ')][@value='preferred'][1]/preceding-sibling::*[contains(@class, ' glossentry/glossAcronym ') or contains(@class, ' glossentry/glossAbbreviation ')][normalize-space(text())!='']">
                        <xsl:value-of
                                select="exsl:node-set($m_matched-target)/*[contains(@class, ' glossentry/glossentry ')][1]//*[contains(@class, ' glossentry/glossStatus ')][@value='preferred'][1]/preceding-sibling::*[contains(@class, ' glossentry/glossAcronym ') or contains(@class, ' glossentry/glossAbbreviation ')][normalize-space(text())!='']"/>
                    </xsl:when>
                    <xsl:when
                            test="exsl:node-set($m_matched-target)/*[contains(@class, ' glossentry/glossentry ')][1]//*[contains(@class, ' glossentry/glossStatus ')][@value!='prohibited'][@value!='obsolete'][1]/preceding-sibling::*[contains(@class, ' glossentry/glossAcronym ') or contains(@class, ' glossentry/glossAbbreviation ')][normalize-space(text())!='']">
                        <xsl:value-of
                                select="exsl:node-set($m_matched-target)/*[contains(@class, ' glossentry/glossentry ')][1]//*[contains(@class, ' glossentry/glossStatus ')][@value!='prohibited'][@value!='obsolete'][1]/preceding-sibling::*[contains(@class, ' glossentry/glossAcronym ') or contains(@class, ' glossentry/glossAbbreviation ')][normalize-space(text())!='']"/>
                    </xsl:when>
                    <xsl:when
                            test="exsl:node-set($m_matched-target)/*[contains(@class, ' glossentry/glossentry ')][1]//*[contains(@class, ' glossentry/glossAlt ')][1]/*[contains(@class, ' glossentry/glossAcronym ') or contains(@class, ' glossentry/glossAbbreviation ')][count(following-sibling::glossStatus)=0][normalize-space(text())!='']">
                        <xsl:value-of
                                select="exsl:node-set($m_matched-target)/*[contains(@class, ' glossentry/glossentry ')][1]//*[contains(@class, ' glossentry/glossAlt ')][1]/*[contains(@class, ' glossentry/glossAcronym ') or contains(@class, ' glossentry/glossAbbreviation ')][count(following-sibling::glossStatus)=0][normalize-space(text())!='']"/>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:value-of
                                select="exsl:node-set($m_matched-target)/*[contains(@class, ' glossentry/glossentry ')][1]/*[contains(@class, ' glossentry/glossterm ')][normalize-space(text())!='']"/>
    ...
    <xsl:template match="*[contains(@class,' topic/term ')]" name="topic.term">
        ...
        <xsl:choose>
            <xsl:when test="@keyref and document($KEYREF-FILE)//*[@keys=$keys][normalize-space(@href)!='']/@href">
                ...
                <xsl:variable name="entry-file"
                              select="concat($WORKDIR, $PATH2PROJ, substring-before($target, '.'), $DITAEXT)"/>
    ...
    <xsl:template match="*[contains(@class,' topic/state ')]" name="topic.state">
        <span style="color:red">
            <xsl:call-template name="commonattributes"/>
            <xsl:call-template name="setidaname"/>
            <xsl:value-of select="name()"/><xsl:text>: </xsl:text><xsl:value-of select="@name"/><xsl:text>=</xsl:text><xsl:value-of
                select="@value"/>
        </span>
    </xsl:template>
    ...
    <xsl:template match="*[contains(@class,' topic/image ')]" name="topic.image">
        ...
        <xsl:if test="$ARTLBL='yes'">[<xsl:value-of select="@href"/>]
        </xsl:if>
    </xsl:template>
        ...
        <xsl:attribute name="longdesc">
            <xsl:choose>
                <xsl:when test="contains(.,$DITAEXT)">  <!-- switch extension from .dita -->
                    <xsl:value-of select="substring-before(.,$DITAEXT)"/><xsl:value-of select="$OUTEXT"/><xsl:value-of
                            select="substring-after(.,$DITAEXT)"/>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:value-of select="."/>
                </xsl:otherwise>
            ...
            <xsl:attribute name="longdesc">
                <xsl:choose>
                    <xsl:when test="contains(@href,$DITAEXT)">  <!-- switch extension from .dita -->
                        <xsl:value-of select="substring-before(@href,$DITAEXT)"/><xsl:value-of select="$OUTEXT"/><xsl:value-of
                                select="substring-after(@href,$DITAEXT)"/>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:value-of select="@href"/>
                    </xsl:otherwise>
    ...
    <xsl:template match="*[contains(@class,' topic/colspec ')]" mode="count-colwidth">
        ...
        <xsl:choose>
            <xsl:when test="following-sibling::*[contains(@class,' topic/colspec ')]">
                <xsl:apply-templates select="following-sibling::*[contains(@class,' topic/colspec ')][1]"
                                     mode="count-colwidth">
    ...
    <xsl:template name="find-entry-start-position">
        <xsl:choose>
            ...
            <xsl:when test="@spanname">
                ...
                <xsl:value-of
                        select="number(count(../../../*[contains(@class,' topic/colspec ')][@colname=$startspan]/preceding-sibling::*)+1)"/>
            </xsl:when>
    ...
    <xsl:template name="find-entry-end-position">
        ...
        <xsl:choose>
            ...
            <xsl:when test="@spanname">
                ...
                <xsl:value-of
                        select="number(count(../../../*[contains(@class,' topic/colspec ')][@colname=$endspan]/preceding-sibling::*)+1)"/>
            </xsl:when>
            <xsl:otherwise>
        ...
        <xsl:choose>
            ...
            <xsl:when test="number($endCurrentRow) &lt; number($startMatchRow)">
                ...
                <xsl:if test="parent::*/parent::*/*[number($endCurrentRow)+1]">
                    <xsl:apply-templates select="parent::*/parent::*/*[number($endCurrentRow)+1]/*[1]"
    ...
    <xsl:template name="add-headers-attribute">
       ...
       templates on all headers, using mode=findmatch; matching IDs are returned. -->
        <xsl:variable name="hdrattr">
            <xsl:apply-templates
                    select="../../../*[contains(@class,' topic/thead ')]/*[contains(@class,' topic/row ')]/*"
                    mode="findmatch">
        ...
        <xsl:if test="string-length($rowheader)>0 or string-length($hdrattr)>0">
            <xsl:attribute name="headers">
                <xsl:value-of select="$rowheader"/><xsl:value-of select="$hdrattr"/>
            </xsl:attribute>
        </xsl:if>
    </xsl:template>
           ...
           Go up to simpletable, into the row, to the entry at column $thiscolnum -->
            <xsl:variable name="header">
                <xsl:if test="parent::*/parent::*/*[contains(@class,' topic/sthead ')]">
                    <xsl:choose>
                        <xsl:when
                                test="parent::*/parent::*/*[contains(@class,' topic/sthead ')]/*[number($thiscolnum)]/@id">
                            <xsl:value-of
                                    select="parent::*/parent::*/*[contains(@class,' topic/sthead ')]/*[number($thiscolnum)]/@id"/>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:value-of
                                    select="generate-id(parent::*/parent::*/*[contains(@class,' topic/sthead ')]/*[number($thiscolnum)])"/>
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:if>
            </xsl:variable>
         ...
         row, so do not create a width value. Otherwise, find out the relative width of this column. -->
            ...
            <xsl:variable name="revtest">
                <xsl:if test="@rev and not($FILTERFILE='') and ($DRAFT='yes')"> <!-- revision? -->
                    <xsl:call-template
                            name="find-active-rev-flag">               <!-- active? (revtest will be 1 when active)-->
                        <xsl:with-param name="allrevs" select="@rev"/>
                    </xsl:call-template>
                </xsl:if>
            </xsl:variable>
    ...
    <xsl:template match="*[contains(@class,' topic/required-cleanup ')]" name="topic.required-cleanup">
        <xsl:if test="$DRAFT='yes'">
            ...
            <div style="background-color: #FFFF99; color:#CC3333; border: 1pt black solid;">
                ...
                <xsl:if test="@remap">[<xsl:value-of select="@remap"/>]
                </xsl:if>
                <xsl:apply-templates/>
                <xsl:call-template name="end-revflag">
                    <xsl:with-param name="flagrules" select="$flagrules"/>
    ...
    <xsl:template name="script-sample">
        <script language="JavaScript">
            <xsl:comment>
                ...
                {
                var
                PopUpWin=window.open(popupitem,"PopUpWin","toolbar=no,directories=no,menubar=no,status=no,scrollbars=yes,resizable=yes,width=500,height=200");
                PopUpWin.focus();
                }
                //
            </xsl:comment>
    ...
    <xsl:template name="spec-title-cell">  <!-- not used - was a cell 'title' -->
        <xsl:if test="@specentry">
            <xsl:value-of select="@specentry"/><xsl:text> </xsl:text>
        </xsl:if>
    </xsl:template>
    ...
    <xsl:template match="*[contains(@class,' topic/fn ')]" mode="text-only">
        ...
        <xsl:choose>
            <xsl:when test="@callout">(<xsl:value-of select="@callout"/>)
            </xsl:when>
            <xsl:otherwise>(<xsl:value-of select="$fnid"/>)
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
        ...
        <div class="p">
            ...
            <xsl:choose>
                ...
                <xsl:otherwise>
                    <a>
                        <xsl:attribute name="name">
                            <xsl:text>fntarg_</xsl:text><xsl:value-of select="$fnid"/>
                        </xsl:attribute>
                        <xsl:attribute name="href">
                            <xsl:text>#fnsrc_</xsl:text><xsl:value-of select="$fnid"/>
                        </xsl:attribute>
                        <sup>
                            <xsl:value-of select="$convergedcallout"/>
                        </sup>
 ...
 +-->
                    ...
                    <span class="tablecap">
                        <xsl:choose>     <!-- Hungarian: "1. Table " -->
                            ...
                            <xsl:otherwise>
                                ...
                                <xsl:text> </xsl:text><xsl:value-of select="$tbl-count-actual"/><xsl:text>. </xsl:text>
                            </xsl:otherwise>
                        </xsl:choose>
                ...
                <span class="figcap">
                    <xsl:choose>      <!-- Hungarian: "1. Figure " -->
                        ...
                        <xsl:otherwise>
                            ...
                            <xsl:text> </xsl:text><xsl:value-of select="$fig-count-actual"/><xsl:text>. </xsl:text>
                        </xsl:otherwise>
                    </xsl:choose>
    ...
    <xsl:template name="generateChapterTitle">
        ...
        <title>
            ...
            <xsl:variable name="schtitle">
                <xsl:value-of
                        select="/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/titlealts ')]/*[contains(@class,' topic/searchtitle ')]"/>
            </xsl:variable>
            <xsl:variable name="ditaschtitle">
                <xsl:value-of
                        select="/dita/*[contains(@class,' topic/topic ')][1]/*[contains(@class,' topic/titlealts ')]/*[contains(@class,' topic/searchtitle ')]"/>
            </xsl:variable>
            ...
            <xsl:variable name="mapschtitle">
                <xsl:value-of
                        select="/*[contains(@class,' topic/topic ')]/*[contains(@class,' topic/titlealts ')]/*[contains(@class,' map/searchtitle ')]"/>
            </xsl:variable>
    ...
    <xsl:template match="*" mode="find-keyref-target">
        ...
        <xsl:choose>
            ...
            <xsl:when test="contains($target,'#')">
                <xsl:value-of
                        select="concat($desDir, substring-before(substring-before($target,'#'),'.'),$OUTEXT,'#',substring-after($target,'#'))"/>
            </xsl:when>
        ...
        <xsl:choose>
            <xsl:when test="$displaytext='' and $keys!=''">
                    ...
                    <xsl:if test="document($KEYREF-FILE)//*[@keys=$keys]">
                        <xsl:choose>
                            <xsl:when test="contains(document($KEYREF-FILE)//*[@keys=$keys]/@href, '#')">
                                <xsl:value-of
                                        select="concat(substring-before(substring-before(document($KEYREF-FILE)//*[@keys=$keys]/@href, '#'), '.'), $DITAEXT)"/>
                            </xsl:when>
                            <xsl:when test="document($KEYREF-FILE)//*[@keys=$keys]/@href">
                                <xsl:value-of
                                        select="concat(substring-before(document($KEYREF-FILE)//*[@keys=$keys]/@href, '.'), $DITAEXT)"/>
                            </xsl:when>
                        </xsl:choose>
                    </xsl:if>
                </xsl:variable>
                <xsl:if test="not($target='' or contains($target, '://'))">
                    <xsl:value-of
                            select="document(concat($WORKDIR, $PATH2PROJ, $target))//*[contains(@class, ' topic/title ')][normalize-space(text())!=''][1]"/>
                </xsl:if>
            </xsl:when>
            <xsl:when test="normalize-space(text())=''">
    ...
    <xsl:template match="*" mode="ditamsg:no-glossentry-for-key">
        ...
        <xsl:call-template name="output-message">
            ...
            <xsl:with-param name="msgparams">%1=<xsl:value-of select="$matching-keys"/>
            </xsl:with-param>
        </xsl:call-template>
    </xsl:template>
    ...
    <xsl:template match="*" mode="ditamsg:longdescref-on-object">
        <xsl:call-template name="output-message">
            ...
            <xsl:with-param name="msgparams">%1=<xsl:value-of select="name(.)"/>
            </xsl:with-param>
        </xsl:call-template>
    </xsl:template>
