...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
        ...
        <html>
            ...
            <body>
                ...
                <span class="grandlien">
                    <a href="#index">Aller à l'index</a>
                    <br/>
                </span>
                <hr/>
                <xsl:apply-templates/>
    ...
    <xsl:template name="nomtype">
        <xsl:choose>
            <xsl:when
                    test="/xs:schema/xs:simpleType[@name=current()/@type]|/xs:schema/xs:complexType[@name=current()/@type]">
                <a href="#type_{@type}">
